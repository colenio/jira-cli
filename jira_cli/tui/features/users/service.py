...
def list_project_users(client: JiraClient, project_key: str, max_results: int = 50) -> list[dict]:
    """List users assignable in the current project."""
    return client.list_assignable_users(project_key, max_results=max_results)


def search_project_users(client: JiraClient, project_key: str, query: str, max_results: int = 20) -> list[dict]:
