...
@click.option("--provider", "provider", default="", help="Provider context to use (jira, github, or demo)")
...
def launch_tui(project: str, provider: str, repository: str, demo: bool) -> None:
